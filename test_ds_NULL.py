...
if __name__ == "__main__":
    ...
    hparams = HParams(
        ...
        # 4090
        # coco_image="/data/lishichao/data/model_edit",
        # mmke_image="/data/lishichao/data/model_edit/MMKE/data_image"
    ...
    # )
    cache_file = (
        f"/home/lishichao/project/EasyEdit/results/loranull/{name}_{model_id.replace('/','_')}_{nsamples}_{seqlen}_{seed}_{size_Caption}_{size_nq}_{size_caption_m_loc}_{size_vqa_loc}_{size_mmke_m_loc}_{size_mmke_loc}_mmke_for_h800_correct.pt"
    )
