...
class CaptionDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        # load image
        img_root = '/data/lishichao/data/model_edit/MMKE/'
        image_path = os.path.join(img_root,data['image'])
        rephrase_image_path = os.path.join(img_root, data['image_rephrase'])
        locality_image_path = os.path.join(img_root, data['multimodal_locality_image'])
